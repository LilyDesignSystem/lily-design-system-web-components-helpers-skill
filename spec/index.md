...
`date-time-picker` — that sit alongside the (partial, 33/491) Web
...
covers the neighbouring, partial (33/491) headless component library
...
- The Web Components headless catalog's own conventions (the partial
  33/491 scope, the two architecture decisions) — that's
...
- [../../lily-design-system-web-components-headless-skill/spec/index.md](../../lily-design-system-web-components-headless-skill/spec/index.md) —
  the sibling skill for the neighbouring, partial (33/491) Web Components
